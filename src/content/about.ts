...
export const aboutContent: Record<Locale, {
  ...
  en: {
    title: "Hi, I’m Kwansik Nam, a product designer",
    introduction: ["I make complex systems easier to use by stripping away the unnecessary and focusing on what matters.", "I like creating the shared foundations that help products feel consistent as they grow."],
    ...
    timeline: [
      ...
      { year: "2023", items: [{ title: "Apple Developer Academy @ POSTECH", description: "Completed the program, with a focus on iOS development and workflows" }, { title: "WWDC23 and KWDC23", description: "Attended WWDC23 and spoke at KWDC23" }, { title: "Swift Student Challenge winner", description: "Built the MellowYellows moon-phase app" }] },
      { year: "2022", items: [{ title: "Yagom Code Starter Camp", description: "Completed a course in Swift fundamentals" }, { title: "Associate degree in Business Administration", description: "National Institute for Lifelong Education" }] },
      { year: "2021", items: [{ title: "ORBRO", description: "UI/UX designer" }, { title: "Service Experience Design Engineer", description: "Earned the Korean national certification in its inaugural examination" }, { title: "Korea University of Technology and Education", description: "B.S. in Design Engineering, Product Design" }] },
      ...
      { year: "2019", items: [{ title: "BCSD LAB", description: "Led design for a student club building campus services" }] },
