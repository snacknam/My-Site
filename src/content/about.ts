...
export const aboutContent: Record<Locale, {
  ...
  en: {
    title: "Kwansik Nam, product designer",
    introduction: ["I reduce complex systems to the essentials.", "I build consistent, scalable design foundations."],
    ...
    timeline: [
      ...
      { year: "2023", items: [{ title: "Apple Developer Academy", description: "POSTECH graduate · iOS development and workflows" }, { title: "WWDC23 and KWDC23", description: "Attended WWDC23 and spoke at KWDC23" }, { title: "Swift Student Challenge winner", description: "Built the MellowYellows moon-phase app" }] },
      { year: "2022", items: [{ title: "Yagom Code Starter Camp", description: "Completed Swift fundamentals training" }, { title: "Associate degree", description: "Business Administration · National Institute for Lifelong Education" }] },
      { year: "2021", items: [{ title: "ORBRO", description: "UI/UX designer" }, { title: "Service Experience Design Engineer", description: "Passed the first Korean national certification exam" }, { title: "Korea University of Technology and Education", description: "B.S. in Design Engineering, Product Design" }] },
      ...
      { year: "2019", items: [{ title: "BCSD LAB", description: "Design lead for a campus service development club" }] },
