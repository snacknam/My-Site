...
export const safetyBellProject: ProjectDetail = {
  ...
  content: {
    ...
    en: {
      ...
      metadata: "Emergency reporting for Gyeonggi residents · Jun–Sep 2022",
      ...
      sections: [
        {
          id: "reporting-system",
          title: "From button press to alert",
        ...
        {
          id: "mobile-report",
          title: "Report status and cancellation",
        ...
        {
          id: "device-management",
          title: "Device connection and updates",
        ...
        {
          id: "monitoring",
          title: "Live reports for responders",
        ...
        {
          id: "retrospective",
          title: "Designing with public agencies",
