...
export const exembleProject: ProjectDetail = {
  ...
  content: {
    ...
    en: {
      name: "Exemble",
      headline: "Turning company knowledge into AI workflows",
      metadata: "Exemble · On-premises AI platform · Oct 2025–Jan 2026",
      ...
      sections: [
        {
          id: "chat-workflow",
          title: "Bringing company knowledge into everyday work",
        ...
        {
          id: "user-admin",
          title: "Different interfaces for different responsibilities",
        ...
        {
          id: "workflow-builder",
          title: "Build, test, and debug workflows visually",
          ...
          media: [{ type: "video", src: "/image/exemble/workflow.mov", label: "Building a workflow with connected nodes", caption: "Connecting workflow steps on the canvas" }],
        },
        {
          id: "workspace",
          title: "Keep the whole workflow in context",
        ...
        {
          id: "trustworthy-chat",
          title: "Make the process behind an answer visible",
        ...
        {
          id: "sources",
          title: "Let users check the sources",
        ...
        {
          id: "data-connection",
          title: "Connect and maintain internal knowledge",
          ...
          media: [
            ...
            { type: "image", src: "/image/exemble/img_6.jpg", alt: "Writing a query to create a vector table", caption: "Creating a vector table with a query" },
          ],
        },
        {
          id: "model-management",
          title: "Manage models and monitor performance",
        ...
        {
          id: "operations-dashboard",
          title: "Move from an overview to the source of an issue",
        ...
        {
          id: "motion",
          title: "Use motion to make system behavior clear",
        ...
        {
          id: "leadership",
          title: "Leading design alongside engineers",
